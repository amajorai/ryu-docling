<p align="center">
  <picture>
    ...
    <img src="./icon-light.png" alt="Docling" width="144" />
  </picture>
</p>
...
Document parsing via IBM's MIT-licensed Docling: the highest-fidelity `document.parse` backend, running real layout analysis rather than handing a model a flat character stream.
...
**App:** [Install](ryu://apps/@ryu/docling) (opens the Ryu desktop app and asks you to confirm)

**CLI:**

```bash
ryu apps add @ryu/docling
```
...
<a href="https://github.com/amajorai/ryu-docling/stargazers">
  <picture>
